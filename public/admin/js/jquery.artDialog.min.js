...
$.dialog.image = function (title, content) {
    return artDialog({
        title  : title, 
...
$.dialog.tips = function (content, time, isbg) {
...
$.dialog.complete = function( content ) {
    return artDialog({
        id: 'FX-Complete',
        title:'操作完成', 
        width:"300px",
