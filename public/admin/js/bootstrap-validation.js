 ...
 * v1.3.3
 *
 * http://ReactiveRaven.github.com/validation/
 */
...
(function( $ ){
      ...
      init : function( options ) {
        ...
        $(uniqueForms).bind("submit", function (e) {
          ...
          if (warningsFound) {
            ...
            if ($.isFunction(settings.options.submitError)) {
              ...
              settings.options.submitError($form, e, $inputs.validation("collectErrors", true));
            }
          } else {
        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            //                                                  REQUIRED
            // ---------------------------------------------------------
            if ($this.attr("data-required") !== undefined || $this.attr("aria-required") !== undefined) {
          ...
          $this.bind(
            "submit.validation", 
            function () { 
              return $this.triggerHandler("click.validation", {submitting: true});
            }
          );
          $this.bind(
            [
  ...
  **/
  ...
  $.validation = function (options) {
    $(":input").not("[type=image],[type=submit]").validation(options);
  }
