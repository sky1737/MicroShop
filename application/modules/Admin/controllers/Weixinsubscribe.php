 ...
 * @since : 2016/8/15
 */
class WeixinSubscribeController extends BaseController {
    ...
    public function init() {
        ...
        $this->_subscribeModel = $this->loadModel('WeixinSubscribe',array(),'Admin');
...
//
        ...
        $data = $this->_subscribeModel->getAllsubscribe($where, $pagination);
