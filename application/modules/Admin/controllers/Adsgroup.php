...
class AdsgroupController extends BaseController {
    ...
    public function init() {
        ...
        $this->_model = $this->loadModel('Adsgroup',array(),'Admin');
        $this->_pageSize = 12;
    }
    ...
    public function indexAction($page=1) {
        ...
        $ads = $this->loadModel('Ads',array(),'Admin')->getList(array('ids' => $ids) );
    ...
    public function getAdAction() {
        $data   = $this->loadModel('Ads',array(),'Admin')->getAdMapByDomain();
        //print_r($data);
