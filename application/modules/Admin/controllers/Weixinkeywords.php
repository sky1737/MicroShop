 ...
 * @since : 2016/8/15
 */
class WeixinKeywordsController extends BaseController {
    ...
    public function init() {
        ...
        $this->_keywordsModel = $this->loadModel('WeixinKeywords',array(),'Admin');
...
//        );
    ...
    public function indexAction($page = 1){
        ...
        $keywordsTypeOption = Helper_Form::option($this->_keywordsType, $type, '请选择内容类型');
        $statusType = Helper_Form::option($this->_keywordsStatus, intval($status), '请选择状态');
        $this->getView()->assign(
            array(
                'keywordsTypeOption' => $keywordsTypeOption,
                'keywordsType' => $this->_keywordsType,
