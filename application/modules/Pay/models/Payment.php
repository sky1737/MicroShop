...
class PaymentModel extends BaseModel {
    ...
    public function createPayment($orderNo, $transaction_id, $mid, $money) {
        ...
        $ret = $this->_db->insert('t_payment')->rows($rows)->execute();
    ...
    public function getJsApiParameters($orderNo, $name, $money) {
        ...
        $input->SetNotify_url("http://wx.visp.info/pay/weixin/notify/");
    ...
    private function isExistOrder($order_no) {
        return $this->_db->select("count(*)")->from('t_payment')->where('p_order_no', $order_no)->fetchValue();
    }
}
